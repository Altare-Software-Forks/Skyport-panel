...
Route::middleware(['auth', EnsureUserIsAdmin::class])
    ...
    ->group(function () {
        ...
        Route::patch('users/{user}', [UsersController::class, 'update'])->name(
            'users.update',
        );
        ...
        Route::post('users/{user}/unsuspend', [
            UsersController::class,
            'unsuspend',
        ...
        Route::delete('users/bulk-destroy', [
            UsersController::class,
            'bulkDestroy',
        ...
        Route::get('cargo', [CargoController::class, 'index'])->name(
            'cargo.index',
        );
        Route::post('cargo', [CargoController::class, 'store'])->name(
            'cargo.store',
        );
        Route::post('cargo/import', [
            CargoController::class,
            'importCargo',
        ])->name('cargo.import');
        Route::patch('cargo/{cargo}', [CargoController::class, 'update'])->name(
            'cargo.update',
        );
        Route::delete('cargo/bulk-destroy', [
            CargoController::class,
            'bulkDestroy',
        ])->name('cargo.bulk-destroy');
        Route::delete('cargo/{cargo}', [
            CargoController::class,
            'destroy',
        ])->name('cargo.destroy');
        ...
        Route::delete('locations/bulk-destroy', [
            LocationsController::class,
            'bulkDestroy',
        ...
        Route::get('nodes', [NodesController::class, 'index'])->name(
            'nodes.index',
        );
        Route::post('nodes', [NodesController::class, 'store'])->name(
            'nodes.store',
        );
        Route::post('nodes/{node}/configure-token', [
            NodesController::class,
            'generateConfigurationToken',
        ])->name('nodes.configure-token');
        ...
        Route::delete('nodes/bulk-destroy', [
            NodesController::class,
            'bulkDestroy',
        ])->name('nodes.bulk-destroy');
        Route::delete('nodes/{node}', [
            NodesController::class,
            'destroy',
        ])->name('nodes.destroy');

        Route::get('servers', [ServersController::class, 'index'])->name(
            'servers.index',
        );
        Route::get('servers/{server}/install-log', [
            ServersController::class,
            'downloadInstallLog',
        ])->name('servers.install-log');
        Route::post('servers/{server}/reinstall', [
            ServersController::class,
            'reinstall',
        ])->name('servers.reinstall');
        Route::post('servers', [ServersController::class, 'store'])->name(
            'servers.store',
        );
        Route::patch('servers/{server}', [
            ServersController::class,
            'update',
        ])->name('servers.update');
        ...
        Route::delete('servers/bulk-destroy', [
            ServersController::class,
            'bulkDestroy',
        ])->name('servers.bulk-destroy');
        Route::delete('servers/{server}', [
            ServersController::class,
            'destroy',
        ])->name('servers.destroy');

        Route::get('activity', [AuditLogController::class, 'index'])->name(
            'activity.index',
        );
...
Route::post('admin/stop-impersonating', [
    UsersController::class,
    'stopImpersonating',
])
