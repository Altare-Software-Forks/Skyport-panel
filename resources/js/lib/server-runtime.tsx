...
export function formatServerAddress(server: {
    allocation: AllocationLike | null;
}): string;
export function formatServerAddress(allocation: AllocationLike | null): string;
export function formatServerAddress(
    input: { allocation: AllocationLike | null } | AllocationLike | null,
): string {
    if (!input) {
